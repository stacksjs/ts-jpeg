...
const nav = [
  ...
  {
    text: 'Changelog',
    link: 'https://github.com/stacksjs/jpgx/blob/main/CHANGELOG.md',
  },
...
const title = 'jpgx | A TypeScript Starter Kit. For a better Development Experience.'
...
export default withPwa(
  defineConfig({
    ...
    head: [
      ...
      ['meta', {
        name: 'tags',
        content: 'jpgx, stacksjs, reverse proxy, modern, lightweight, zero-config, local development',
      }],
      ...
      ['meta', { property: 'og:site_name', content: 'jpgx' }],
      ['meta', { property: 'og:image', content: './images/og-image.png' }],
      ['meta', { property: 'og:url', content: 'https://jpgx.netlify.app/' }],
    ...
    themeConfig: {
      ...
      socialLinks: [
        ...
        { icon: 'github', link: 'https://github.com/stacksjs/jpgx' },
